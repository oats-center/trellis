...
In the following table, `/suffix` means `@oatscenter/trellis/suffix`.

| Entrypoint                   | Runtime values                                                                                                                                         | Type-only names                                                                                                                                                                                                                                                                                                                                                                                         |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@oatscenter/trellis`        | `AsyncResult`, `BaseError`, `isErr`, `isJsonValue`, `ok`, `Result`, `StoreError`, `TransferError`, `TrellisClient`, `TrellisDevice`, `UnexpectedError` | `JsonValue`, `ReceiveTransferGrant`                                                                                                                                                                                                                                                                                                                                                                     |
...
| `@oatscenter/result`         | `AsyncResult`, `BaseError`, `isErr`, `UnexpectedError`                                                                                                 | `Result`                                                                                                                                                                                                                                                                                                                                                                                                |
| `@oatscenter/trellis-svelte` | `createDeviceActivationController`, `createPortalFlow`, `createTrellisApp`, `TrellisProvider`                                                          | `DeviceActivationAuth`, `DeviceActivationOperationRef`, `TrellisClientFor`                                                                                                                                                                                                                                                                                                                              |
| `@oatscenter/trellis-test`   | `TrellisTestRuntime`                                                                                                                                   | None                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| -------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| `@oatscenter/trellis`      | `createAuth`, `TrellisClient`                 | `CallerParticipant`, `CallerRuntime`, `ClientAuthContinuation`, `ClientAuthOptions`, `ClientAuthRequiredContext`, `ClientOpts` | Present                 |
...
These implementations do not import the public `@oatscenter/trellis` package
...
| ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@oatscenter/result`                           | `AsyncResult`, `BaseError`, `err`, `isErr`, `MaybeAsync`, `ok`, `Result`, `UnexpectedError`                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
