...
In the following table, `/suffix` means `@oats-center/trellis/suffix`.

| Entrypoint                    | Runtime values                                                                                                                                         | Type-only names                                                                                                                                                                                                                                                                                                                                                                                         |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@oats-center/trellis`        | `AsyncResult`, `BaseError`, `isErr`, `isJsonValue`, `ok`, `Result`, `StoreError`, `TransferError`, `TrellisClient`, `TrellisDevice`, `UnexpectedError` | `JsonValue`, `ReceiveTransferGrant`                                                                                                                                                                                                                                                                                                                                                                     |
...
| `@oats-center/result`         | `AsyncResult`, `BaseError`, `isErr`, `UnexpectedError`                                                                                                 | `Result`                                                                                                                                                                                                                                                                                                                                                                                                |
| `@oats-center/trellis-svelte` | `createDeviceActivationController`, `createPortalFlow`, `createTrellisApp`, `TrellisProvider`                                                          | `DeviceActivationAuth`, `DeviceActivationOperationRef`, `TrellisClientFor`                                                                                                                                                                                                                                                                                                                              |
| `@oats-center/trellis-test`   | `TrellisTestRuntime`                                                                                                                                   | None                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| -------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| `@oats-center/trellis`     | `createAuth`, `TrellisClient`                 | `CallerParticipant`, `CallerRuntime`, `ClientAuthContinuation`, `ClientAuthOptions`, `ClientAuthRequiredContext`, `ClientOpts` | Present                 |
...
These implementations do not import the public `@oats-center/trellis` package
...
| ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@oats-center/result`                          | `AsyncResult`, `BaseError`, `err`, `isErr`, `MaybeAsync`, `ok`, `Result`, `UnexpectedError`                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
