...
pub mod errors {
    ...
    impl NotFoundError {
        pub fn payload(
            ...
            crate::__types::trellis::EventsNotFoundErrorData,
            serde_json::Error,
        > {
            let mut payload = self.error.extra.clone();
            payload
...
pub mod rpc {
    ...
    pub type ConsumersReportDeliveryInput = crate::__types::trellis::EventsConsumersReportDeliveryRequest;
    pub type ConsumersReportDeliveryOutput = crate::__types::trellis::EventsConsumersReportDeliveryResponse;
...
impl Client {
        ...
        Box::pin(
            futures_util::stream::try_unfold(
                (
                    ...
                    seen,
                    false,
                    Vec::<crate::__types::trellis::EventConsumerStatusRow>::new()
                        .into_iter(),
                ),
    ...
    pub async fn diagnostics(
        ...
        rpc::DiagnosticsOutput,
        trellis_rs::client::CallError<rpc::DiagnosticsError>,
    > {
...
impl<'a, P: trellis_rs::generated::ParticipantDescriptor> Provider<'a, P> {
    ...
    where
        ...
        Fut: std::future::Future<
            ...
            > + Send + 'static,
    {
        self.runtime.register_rpc::<rpc::ConsumersReportDelivery, _, _>(handler);
    }
    pub fn register_dead_letters_dismiss<F, Fut>(&mut self, handler: F)
    where
        F: Fn(
                trellis_rs::service::ServiceHandlerContext,
                rpc::DeadLettersDismissInput,
            ) -> Fut + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<
                    rpc::DeadLettersDismissOutput,
            ...
            > + Send + 'static,
    {
        self.runtime.register_rpc::<rpc::DeadLettersDismiss, _, _>(handler);
    }
    pub fn register_dead_letters_inspect<F, Fut>(&mut self, handler: F)
    where
        F: Fn(
                trellis_rs::service::ServiceHandlerContext,
                rpc::DeadLettersInspectInput,
            ) -> Fut + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<
                    rpc::DeadLettersInspectOutput,
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::DiagnosticsInput) -> Fut
            + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::DiagnosticsOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::InspectInput) -> Fut
            + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::InspectOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::MetricsInput) -> Fut
            + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::MetricsOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::QueryInput) -> Fut + Send
            + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::QueryOutput>,
            > + Send + 'static,
    {
