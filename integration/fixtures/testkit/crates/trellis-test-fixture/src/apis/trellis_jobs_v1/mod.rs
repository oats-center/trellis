...
impl Client {
    ...
    pub async fn dismiss_dlq(
        ...
        rpc::DismissDLQOutput,
        trellis_rs::client::CallError<rpc::DismissDLQError>,
    > {
    ...
    pub async fn list_services(
        ...
        rpc::ListServicesOutput,
        trellis_rs::client::CallError<rpc::ListServicesError>,
    > {
        ...
        Box::pin(
            futures_util::stream::try_unfold(
                (
                    ...
                    seen,
                    false,
                    Vec::<crate::__types::trellis::JobsQueryResponseentriesItem>::new()
                        .into_iter(),
                ),
                |(client, mut input, mut seen, mut done, mut items)| async move {
                    loop {
    ...
    pub async fn replay_dlq(
        ...
        rpc::ReplayDLQOutput,
        trellis_rs::client::CallError<rpc::ReplayDLQError>,
    > {
...
impl<'a, P: trellis_rs::generated::ParticipantDescriptor> Provider<'a, P> {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::CancelInput) -> Fut + Send
            + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::CancelOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::DismissDLQInput) -> Fut
            + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::DismissDLQOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::GetKeyInput) -> Fut + Send
            + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::GetKeyOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::ListDLQInput) -> Fut
            + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::ListDLQOutput>,
            > + Send + 'static,
    {
    ...
    where
        ...
        Fut: std::future::Future<
            ...
            > + Send + 'static,
    {
        self.runtime.register_rpc::<rpc::ListServices, _, _>(handler);
    }
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::ReplayDLQInput) -> Fut
            + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::ReplayDLQOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::RetryInput) -> Fut + Send
            + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::RetryOutput>,
            > + Send + 'static,
    {
    ...
    where
        F: Fn(trellis_rs::service::ServiceHandlerContext, rpc::SummaryInput) -> Fut
            + Send + Sync + 'static,
        Fut: std::future::Future<
                Output = trellis_rs::service::HandlerResult<rpc::SummaryOutput>,
            > + Send + 'static,
    {
