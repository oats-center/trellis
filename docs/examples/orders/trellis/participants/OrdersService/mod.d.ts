...
declare const __participant: {
	...
	readonly id: "acme-orders.OrdersService";
	readonly identity: "acme-orders.OrdersService";
	readonly path: "OrdersService";
...
export declare const PARTICIPANT_DIGEST: "kWeMPGnhB6W5HBkUqXihR5b9EpXeLpfZrQv1Zhu7VW8";
